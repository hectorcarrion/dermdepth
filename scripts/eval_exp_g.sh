#!/bin/bash
# Evaluate Exp G checkpoints on WoundsDB test, SKINL2 test, and DDI rulers
set -e

GPU=3
CKPT_DIR="output/training/exp_g/checkpoint"
STEPS="200 400 600 800 1000 1200 1400 1600 1800"

echo "============================================"
echo "Exp G Evaluation: WoundsDB + SKINL2 + DDI"
echo "============================================"
...
for STEP in $STEPS; do
    ...
    # DDI rulers: save predictions then evaluate
